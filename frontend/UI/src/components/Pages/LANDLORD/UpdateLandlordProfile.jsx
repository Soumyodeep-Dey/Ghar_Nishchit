...
import { User, Mail, Lock, Phone, Eye, EyeOff, Image as ImageIcon, AlertTriangle, Trash2, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className={`text-sm ${tc.textSecondary} mt-1`}>
                      Manage your personal credentials and options as a Landlord.
                    </p>
                  </div>
                  <button
                    onClick={() => navigate(-1)}
                ...
                <div className={`p-6 border rounded-2xl mt-8 shadow-md ${tc.dangerBg}`}>
                  ...
                  <p className="text-sm mb-4">
                    Deleting your account is permanent. All property listings, active leases, payout logs, and message histories will be deleted forever.
                  </p>
                  <button
                    onClick={handleDeleteAccount}
                    className={`py-3 px-6 rounded-xl font-bold text-white bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-650 hover:to-pink-600 shadow-md transition-all hover:scale-105 flex items-center justify-center gap-2`}
                  >
                    <Trash2 size={16} />
